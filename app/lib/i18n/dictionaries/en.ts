...
const en = {
  ...
  team: {
    ...
    people: {
      ...
      "hashim-hashimdan": ["Videographer"],
      "zeynep-nehir-karap": ["Investment Advisor"],
      ...
      "muhammad-mubashir": ["Investment Advisor"],
      "muhammet-kurtulus": ["Senior Investment Advisor"],
      "maryam-shad": ["Social Media Manager"],
      "muhammad-jamal": ["Investment Advisor"],
      "sinan-sadikhov": ["Investment Advisor"],
      "kubra-senturk": ["Legal Advisor"],
      ...
      "badar-naseem": ["Investment Advisor"],
      "iffah-mir": ["Graphic Designer"],
      "amina-ashraf": ["Content Developer"],
      "faizan-asif": ["Website/SEO Specialist"],
      "sarmad-al-kaseer": ["Senior Investment Advisor"],
    },
    cta: {
