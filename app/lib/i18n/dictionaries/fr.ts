...
const fr: Dictionary = {
  ...
  team: {
    ...
    people: {
      ...
      "hashim-hashimdan": ["Fonction à confirmer"],
      "zeynep-nehir-karap": ["Fonction à confirmer"],
      ...
      "muhammad-mubashir": ["Conseiller en investissement"],
      "muhammet-kurtulus": ["Conseiller principal en investissement"],
      "maryam-shad": ["Responsable des réseaux sociaux"],
      "muhammad-jamal": ["Conseiller en investissement"],
      "sinan-sadikhov": ["Conseiller en investissement"],
      "kubra-senturk": ["Conseillère juridique"],
      ...
      "badar-naseem": ["Conseiller en investissement"],
      "iffah-mir": ["Graphiste"],
      "amina-ashraf": ["Conceptrice de contenu"],
      "faizan-asif": ["Spécialiste site web et SEO"],
      "sarmad-al-kaseer": ["Conseiller principal en investissement"],
    },
    cta: {
